...
<head>
    ...
    <title>Budgetly - Add New Category</title>
            ...
            <div
                ...
                <div class="p-8 border-b border-primary/5">
                    <div class="flex items-center justify-between">
                        <div>
                            <h2 class="text-2xl font-bold text-slate-900 dark:text-white">Add New Category</h2>
                            <p class="text-sm text-slate-500">Organize your finances with custom categories.</p>
                        </div>
                ...
                <form method="post" action="<?= base_url('profile/categories/store') ?>" class="p-8 space-y-8">
                    <?= csrf_field() ?>
                        ...
                        <div class="inline-flex p-1 bg-slate-100 dark:bg-slate-900 rounded-xl w-full max-w-sm">
                            <div class="flex-1">
                                <input type="radio" name="type" id="type-expense" value="expense"
                                    class="sr-only peer" <?= old('type', 'expense') == 'expense' ? 'checked' : '' ?>>
                            ...
                            <div class="flex-1">
                                <input type="radio" name="type" id="type-income" value="income"
                                    class="sr-only peer" <?= old('type') == 'income' ? 'checked' : '' ?>>
